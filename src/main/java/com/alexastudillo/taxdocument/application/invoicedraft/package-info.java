/**
 * Application boundary for creating and reviewing an Invoice Draft.
 *
 * <p>This package coordinates the use case and its capability-local outbound ports using explicit
