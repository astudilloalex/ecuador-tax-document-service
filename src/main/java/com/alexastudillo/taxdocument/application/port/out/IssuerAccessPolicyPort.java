...
public interface IssuerAccessPolicyPort {
    AccessDecision canIssue(String actorId, Issuer issuer, Establishment establishment, IssuingPoint issuingPoint);

    AccessDecision canInspect(String actorId, Issuer issuer, Establishment establishment, IssuingPoint issuingPoint);
