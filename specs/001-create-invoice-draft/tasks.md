...
- [ ] T002 Configure only the approved Quarkus REST/Jackson, validation, Hibernate Reactive Panache, reactive PostgreSQL, Flyway JDBC migration, OpenAPI, Health, Micrometer, OpenTelemetry, JUnit 5, REST Assured, UniAsserter, PostgreSQL test, formatting, and static-analysis capabilities in `build.gradle.kts`
...
- [ ] T007 Configure sanitized PostgreSQL, Flyway, timeout, observability, and deterministic clock/identifier overrides for tests in `src/test/resources/application.properties`
...
- [ ] T008 Create reusable real-PostgreSQL lifecycle and row-count support for migration, transaction, timeout, and concurrency evidence in `src/test/java/com/alexastudillo/taxdocument/infrastructure/invoicedraft/PostgreSqlTestResource.java`
...
- [ ] T019 [P] [US1] Add pure BigDecimal calculation, rounding, exact intermediate, zero-value, range, and deterministic repetition tests using T017 for FR-010–FR-016/FR-044/DR-002–DR-011/DR-016/SC-003–SC-004/SC-011/SC-029 in `src/test/java/com/alexastudillo/taxdocument/domain/invoicedraft/InvoiceDraftCalculatorTest.java`
- [ ] T020 [P] [US1] Add all five approved buyer strategy, final-consumer USD 50.00, activity/effectivity, and no-checksum/registry tests for FR-007/FR-028/DR-001/DR-014–DR-015/SC-010 in `src/test/java/com/alexastudillo/taxdocument/domain/invoicedraft/BuyerTest.java`
- [ ] T021 [P] [US1] Add one-effective-IVA-rule, four-treatment, separate-zero-group, caller-selection, non-IVA, multiple-tax, and no-classification tests for FR-010–FR-012/DR-001/DR-005/DR-008/SC-009/SC-021 in `src/test/java/com/alexastudillo/taxdocument/domain/invoicedraft/InvoiceDraftTaxTest.java`
- [ ] T022 [P] [US1] Add positive-total, zero-total, exact reconciliation, duplicate-method, cardinality, and overflow tests for FR-013–FR-014/DR-016/DR-022/SC-011/SC-020/SC-029 in `src/test/java/com/alexastudillo/taxdocument/domain/invoicedraft/PaymentReconciliationTest.java`
- [ ] T023 [P] [US1] Add aggregate status, USD, local identifier, immutable Company ownership, opaque emission point, child membership, calculated-input exclusion, and no-snapshot tests for FR-004–FR-005/FR-017–FR-024/FR-037–FR-038/DR-020/DR-023/SC-001/SC-005/SC-007/SC-017/SC-022 in `src/test/java/com/alexastudillo/taxdocument/domain/invoicedraft/InvoiceDraftTest.java`
...
- [ ] T025 [P] [US1] Add one-instant America/Guayaquil current-date, impossible/different-date, midnight-commit, confirmed-createdAt, and later-date replay tests for FR-006/FR-019/FR-033/DR-012/SC-013/SC-030 in `src/test/java/com/alexastudillo/taxdocument/application/invoicedraft/RequestDatePolicyTest.java`
...
- [ ] T027 [P] [US1] Add application use-case tests for exact FR-041 precedence, Company UUID mapping/scoping, local replay/conflict, current validation, calculation, atomic command handoff, response loss, and zero external calls for FR-001–FR-043/SC-001–SC-002/SC-012/SC-023/SC-026/SC-028 in `src/test/java/com/alexastudillo/taxdocument/application/invoicedraft/CreateInvoiceDraftUseCaseTest.java`
- [ ] T028 [P] [US1] Add OpenAPI parse/reference, operation, required-header, strict-schema, decimal, response, error-status, and security-absence contract tests for FR-001–FR-005/FR-022/FR-025–FR-027/FR-039/FR-042/FR-044/SC-024–SC-025/SC-027/SC-032 in `src/test/java/com/alexastudillo/taxdocument/api/invoicedraft/InvoiceDraftOpenApiContractTest.java`
...
- [ ] T033 [P] [US1] Add real-PostgreSQL active/effective reference lookup, exact approved metadata, unknown/inactive/ambiguous rejection, and consistent-state tests for FR-007/FR-011/FR-013/FR-045–FR-047/DR-001/SC-009–SC-010/SC-021/SC-031–SC-032 in `src/test/java/com/alexastudillo/taxdocument/infrastructure/invoicedraft/ReferenceDataRepositoryAdapterTest.java`
- [ ] T034 [P] [US1] Add real-PostgreSQL aggregate round-trip, Company-plus-draft scoping, local child ownership, composite binding integrity, numeric constraint, and all-or-nothing transaction tests for FR-020–FR-024/FR-030/FR-037/FR-044/SC-001–SC-002/SC-017/SC-022/SC-029 in `src/test/java/com/alexastudillo/taxdocument/infrastructure/invoicedraft/InvoiceDraftRepositoryAdapterTest.java`
...
- [ ] T036 [P] [US1] Add injected failure after every write phase plus unavailable, query/write timeout, uncertain commit, and post-commit response-loss recovery tests for FR-020–FR-021/FR-032/FR-043/SC-002/SC-028 in `src/test/java/com/alexastudillo/taxdocument/infrastructure/invoicedraft/InvoiceDraftRollbackTest.java`
...
- [ ] T050 [US1] Implement deterministic line-level HALF_UP calculation, aggregation, overflow checks, and payment reconciliation for FR-012–FR-016/FR-044/DR-002–DR-011/DR-016 in `src/main/java/com/alexastudillo/taxdocument/domain/invoicedraft/InvoiceDraftCalculator.java`
- [ ] T051 [US1] Implement the USD DRAFT aggregate with immutable CompanyId, opaque emission point, buyer, ordered lines, taxes, payments, additional information, totals, timestamps, and no fiscal snapshot for FR-004–FR-024/FR-037–FR-038/DR-020/DR-023 in `src/main/java/com/alexastudillo/taxdocument/domain/invoicedraft/InvoiceDraft.java`

### Application Implementation for User Story 1

- [ ] T052 [P] [US1] Define the transport-independent command carrying application CompanyId, one request instant, idempotency/correlation evidence, and normalized commercial inputs for FR-004–FR-015/FR-026–FR-029/FR-040 in `src/main/java/com/alexastudillo/taxdocument/application/invoicedraft/CreateInvoiceDraftCommand.java`
...
- [ ] T057 [P] [US1] Define the single-capture request and commit clock boundary for FR-006/FR-019/DR-012 in `src/main/java/com/alexastudillo/taxdocument/application/invoicedraft/RequestClock.java`
...
- [ ] T061 [US1] Implement FR-041 orchestration, Company-scoped replay/conflict, current catalog/domain validation, deterministic calculation, atomic repository handoff, uniqueness-winner recovery, and safe terminal results for FR-001–FR-047 in `src/main/java/com/alexastudillo/taxdocument/application/invoicedraft/CreateInvoiceDraftService.java`
...
- [ ] T073 [P] [US1] Implement reactive local effective-date lookups and ambiguity rejection for the approved buyer, IVA, and payment catalogs for FR-007/FR-011/FR-013/FR-045–FR-047 in `src/main/java/com/alexastudillo/taxdocument/infrastructure/invoicedraft/ReferenceDataRepositoryAdapter.java`
- [ ] T074 [P] [US1] Implement reactive Company-scoped binding/root reads, atomic root/children/binding persistence, unique-race rollback and winner re-read, and safe timeout/unavailable mapping for FR-020–FR-024/FR-027–FR-034/FR-043 in `src/main/java/com/alexastudillo/taxdocument/infrastructure/invoicedraft/InvoiceDraftRepositoryAdapter.java`
- [ ] T075 [P] [US1] Implement the injectable system clock adapter for one request instant and confirmed commit instants for FR-006/FR-019/DR-012 in `src/main/java/com/alexastudillo/taxdocument/infrastructure/invoicedraft/SystemRequestClock.java`
...
- [ ] T084 [US1] Implement explicit request-to-command Company UUID/business-input mapping and result-to-response mapping for FR-022/FR-037/FR-040 in `src/main/java/com/alexastudillo/taxdocument/api/invoicedraft/InvoiceDraftApiMapper.java`
...
- [ ] T086 [US1] Expose POST `/api/v1/invoice-drafts` with required Company/idempotency headers, optional correlation, 201 new, 200 replay, and complete response semantics for FR-001–FR-003/FR-017–FR-022/FR-026–FR-033 in `src/main/java/com/alexastudillo/taxdocument/api/invoicedraft/InvoiceDraftResource.java`
- [ ] T087 [P] [US1] Publish the validated target-first OpenAPI 3.1 contract without security, Company path/query/body input, or 401/403 outcomes for FR-002/FR-039/SC-024 in `src/main/resources/META-INF/openapi.yaml`
