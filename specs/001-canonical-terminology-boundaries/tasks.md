...
- [X] T001 Create durable documentation directories `docs/architecture/` and
  `docs/migration/`. (FR-013, FR-014, Plan `Project Structure`)
- [X] T002 [P] Create the required heading outline in
...
- [X] T003 [P] Create the required heading outline in
...
- [X] T004 [P] Create the required heading outline in
...
- [X] T007 [P] Add terminology traceability rules to
...
- [X] T008 [P] Add mapping source-of-truth and extension rules to
...
- [X] T009 Add documentation governance and durable location rules to
...
- [X] T010 [US1] Document artifact-specific format rules in
...
- [X] T011 [US1] Populate approved canonical terms in
...
- [X] T012 [US1] Document business-oriented English naming guidance and
  literal-translation rejection rules in
  `docs/architecture/canonical-terminology.md`. (NR-001, SC-006)
- [X] T013 [US1] Document forbidden generic business names in
  ...
  NR-020)
- [X] T014 [P] [US1] Populate the approved baseline mapping table in
...
- [X] T015 [US1] Document Pending Naming Decision registration and resolution
...
- [X] T016 [US1] Validate User Story 1 by comparing
  `docs/architecture/canonical-terminology.md` and
...
- [X] T017 [US2] Document SRI contract isolation rules in
...
- [X] T018 [P] [US2] Document SRI adapter-only concept rules in
...
- [X] T019 [US2] Document compatibility exception records in
...
- [X] T020 [US2] Document the rejection rule for Spanish SRI or legacy names in
...
- [X] T021 [US2] Validate User Story 2 by checking
...
- [X] T022 [US3] Document dependency direction in
...
- [X] T023 [US3] Document layer responsibilities in
...
- [X] T024 [US3] Document use case-centered design rules in
...
- [X] T025 [US3] Document Ports and Adapters rules in
...
- [X] T026 [US3] Document DTO separation and required mapping flow in
...
- [X] T027 [US3] Document transport, application, and domain validation
...
- [X] T028 [US3] Document future critical-operation idempotency, auditability,
...
- [X] T029 [US3] Document forbidden practices and a spec/plan/task/code
...
- [X] T030 [P] [US3] Document Pending Functional Validation registration,
...
- [X] T031 [US3] Validate User Story 3 by checking
  `docs/architecture/backend-clean-architecture.md` and
  `docs/migration/legacy-to-target-terminology.md` against
  `specs/001-canonical-terminology-boundaries/contracts/architecture-rules-document.md`
  and
...
- [X] T032 Run the validation commands from
...
- [X] T033 Verify no runtime artifacts were created or required under
...
- [X] T034 Cross-check `docs/architecture/backend-clean-architecture.md`,
