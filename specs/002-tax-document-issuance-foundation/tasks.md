...
- [X] T001 Create root package boundary documentation in
...
- [X] T002 [P] Create tax document domain package documentation in
  `src/main/java/com/alexastudillo/taxdocument/domain/taxdocument/package-info.java`
  (FR-001, AR-001, NR-001).
- [X] T003 [P] Create application issuance and output port package
  documentation in
...
- [X] T004 [P] Create matching test package documentation in
...
- [X] T005 [P] Create the domain exception foundation in
...
- [X] T006 [P] Create application issuance error support in
...
- [X] T007 [P] [US1] Add document type support tests in
  ...
  FR-003, NR-004).
- [X] T008 [P] [US1] Add access key validation tests in
  ...
  (FR-004, FR-013).
- [X] T009 [P] [US1] Add issuer numbering identity tests in
...
- [X] T010 [US1] Implement the canonical document type model in
...
- [X] T011 [US1] Implement the access key value object in
...
- [X] T012 [P] [US1] Implement authorization and date value objects in
...
- [X] T013 [P] [US1] Implement issuer context value objects in
...
- [X] T014 [P] [US1] Implement the sequence number value object in
  ...
  (FR-007, FR-015).
- [X] T015 [US1] Implement the initial tax document aggregate identity and
  required fields in
...
- [X] T016 [P] [US2] Add document state transition tests in
  ...
  FR-008).
- [X] T017 [P] [US2] Add authorization state separation tests in
  ...
  (FR-006, AR-001).
- [X] T018 [P] [US2] Add authorized-document immutability tests in
...
- [X] T019 [P] [US2] Add local voiding rule tests in
...
- [X] T020 [P] [US2] Add retry eligibility tests in
...
- [X] T021 [US2] Implement canonical document states in
...
- [X] T022 [P] [US2] Implement authorization states in
...
- [X] T023 [P] [US2] Implement issuance mode in
...
- [X] T024 [US2] Implement common lifecycle transition rules in
...
- [X] T025 [US2] Extend
  ...
  FR-009, FR-011).
- [X] T026 [US2] Implement application retry eligibility policy in
...
- [X] T027 [P] [US3] Add issuance request model tests in
...
- [X] T028 [P] [US3] Add issuance result model tests in
  ...
  (FR-014, FR-019).
- [X] T029 [P] [US3] Add audit event name tests in
  ...
  (FR-016).
- [X] T030 [P] [US3] Add application port boundary tests in
...
- [X] T031 [US3] Implement the application issuance request model in
...
- [X] T032 [US3] Implement the application issuance result model in
...
- [X] T033 [P] [US3] Implement canonical audit event names in
...
- [X] T034 [P] [US3] Implement persistence, access, sequence, and access-key
  output ports in
  ...
  AR-008).
- [X] T035 [P] [US3] Implement SRI, XML storage, queue, and webhook output
  ports in
...
- [X] T036 [P] [US3] Implement clock, transaction, and audit output ports in
...
- [X] T037 [US4] Update canonical foundation terms in
...
- [X] T038 [US4] Update common concept mappings in
...
- [X] T039 [US4] Update SRI document code mappings in
  ...
  (FR-003, NR-004).
- [X] T040 [US4] Update legacy state mappings in
...
- [X] T041 [US4] Update Pending Functional Validation records in
...
- [X] T042 Run `./gradlew test` and record the outcome in
  ...
  (FR-013).
- [X] T043 [P] Run source scope guard checks from
...
- [X] T044 [P] Run terminology checks from
...
- [X] T045 [P] Verify source imports in
  ...
  FR-014).
- [X] T046 [P] Verify durable documentation updates in
...
- [X] T047 [Process] Prepare a pull request summary in
...
- [X] T048 [Process] Create or prepare a GitHub pull request from the feature
